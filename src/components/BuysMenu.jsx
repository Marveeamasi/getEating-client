...
getSells()
  ...
  return (
    <>
    <div className='fixed border-2 border-[#ff4800] rounded-full w-[50px]  h-[50px] right-[20px] bottom-[20px] animate-bounce hover:animate-none z-[70] p-5 flex justify-center items-center '>
