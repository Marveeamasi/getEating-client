...
const Confirm = ({handling, message, toggle}) => {
  return (
    <div className='w-[300px] fixed h-[250px] top-[50%] z-[80] left-[50%] mt-[-150px] ml-[-125px] glasss bg-[#ffffffe6] shadow-md rounded-md flex flex-col justify-center items-center text-center'>
